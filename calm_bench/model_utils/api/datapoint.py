...
import calm_bench.model_utils
from calm_bench.model_utils.api._model_methods import MODEL_METHODS
from calm_bench.model_utils.api.exception import APIError
from calm_bench.model_utils.api.types import PartialObj
from calm_bench.model_utils.model.exception import ModelError
...
class Datapoint(BaseModel, abc.ABC):
    ...
    @abc.abstractmethod
    def evaluate(self, api: calm_bench.model_utils.API) -> EvaluationResult:
...
class GenerateDatapoint(Datapoint):
    ...
    def evaluate(self, api: calm_bench.model_utils.API) -> calm_bench.model_utils.EvaluationResult:
        raise NotImplementedError
