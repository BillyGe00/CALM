...
from calm_bench.types import (
    Action,
    RewardResult,
    CalendarRewardInfo,
    RESPOND_ACTION_NAME,
)
from calm_bench.envs.calendar.data import load_data
from calm_bench.envs.calendar.tools import ALL_TOOLS
from calm_bench.envs.calendar.wiki import WIKI
from calm_bench.envs.calendar.rules import RULES
from calm_bench.envs.calendar.tasks import get_tasks
from calm_bench.envs.calendar.reward import calculate_calendar_reward
...
class MockCalendarDomainEnv(Env):
    def __init__(
        ...
        match task_split:
            case "test":
                from calm_bench.envs.calendar.tasks_test import TASKS_TEST as tasks
            case "train":
                from calm_bench.envs.calendar.tasks_train import TASKS_TRAIN as tasks
            case "dev":
                from calm_bench.envs.calendar.tasks_dev import TASKS_DEV as tasks
            case _:
